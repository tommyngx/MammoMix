...
def main(config_path, epoch=None, dataset=None):
    ...
    training_args = TrainingArguments(
        ...
        evaluation_strategy="epoch",  # Use this instead of eval_strategy
        save_strategy="epoch",
        save_total_limit=save_total_limit,
        logging_strategy="epoch",  # Enable logging for each epoch
        report_to="all",  # Enable all available reporting
